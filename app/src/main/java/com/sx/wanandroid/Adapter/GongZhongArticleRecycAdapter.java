...
public class GongZhongArticleRecycAdapter extends RecyclerView.Adapter<GongZhongArticleRecycAdapter.MyViewHolder> {
    ...
    public GongZhongArticleRecycAdapter(Context context) {
